_: {
  # Note: Active/inactive border colours and groupbar colors are supplied by noctalia.conf (see _general.nix)
  # to dynamically match the wallpaper-driven scheme.
