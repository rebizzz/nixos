  ...
  flake.modules.nixos.nixarr = {
    ...
    systemd = {
      ...
      tmpfiles.rules = [
        ...
        "Z /mnt/data/media/torrents 2775 transmission media -"
        "Z /mnt/data/media/library 2775 root media -"
      ];
      ...
      services = {
        ...
        sonarr-sync-config.serviceConfig = {
          Restart = "on-failure";
          RestartSec = "5s";
          TimeoutStartSec = "120s";
        };
        radarr-sync-config.serviceConfig = {
          Restart = "on-failure";
          RestartSec = "5s";
          TimeoutStartSec = "120s";
        };
        prowlarr-sync-config.serviceConfig = {
          Restart = "on-failure";
          RestartSec = "5s";
          TimeoutStartSec = "120s";
        };
        bazarr-sync-config.serviceConfig = {
          Restart = "on-failure";
          RestartSec = "5s";
          TimeoutStartSec = "120s";
        };
