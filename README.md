...
- **Secrets:** [sops-nix](https://github.com/Mic92/sops-nix) with `age` keys, also used for wifi credentials and the login password
- **Modules:** dendritic pattern via `flake-parts` + `import-tree`, every file declares its own module and gets picked up automatically
